...
/*   Updated: 2023/03/23 13:35:01 by akisuzuk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static	void	ft_putchar_rep(char c, int fd, int rep)
{
	int	i;
...
static	void	ft_print_percent(t_flag *info)
{
	info->putlen = 1;
...
static	int ft_get_digit(int num, int base)
{
	int	digit;
	int basenum;
...
static	void	ft_get_putlen(t_flag *info, int num)
{
...
static	void	ft_unsigned_print(va_list *arg, t_flag *info)
{
	unsigned int num;
...
static	void ft_int_print(va_list *arg, t_flag *info)
{
	int num;
...
static	int	ft_non_specifier(const char **p, const char **format, t_flag *info)
{
	if (!**format)
		return (-1);
